...
void velocity_callback(const void * msgin) {
    ...
    // Ajustar velocidad del motor basado en la velocidad objetivo
    currentPWMLeft = currentPWMRight = map(targetSpeed, 0, MAX_SPEED, 0, MAX_PWM);
    currentPWMLeft = currentPWMRight = constrain(currentPWMLeft, 0, 255);
